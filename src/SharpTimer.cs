...
namespace SharpTimer
{
    ...
    public partial class SharpTimer : BasePlugin
    {
        ...
        {
            SharpTimerConPrint("Načítavam plugin...");
            CheckForUpdate();
                    ...
                    if (player.IsValid && player.IsBot)
                    {
                        if (startKickingAllFuckingBotsExceptReplayOneIFuckingHateValveDogshitFuckingCompanySmile)
                        {
                            AddTimer(4.0f, () =>
                            {
                                ...
                                SharpTimerDebug($"Vykopujem nepoužívaného bota na spawne");
                            });
                        }
                    }
            ...
            RegisterEventHandler<EventRoundStart>((@event, info) =>
            {
                ...
                LoadMapData(mapName);
                SharpTimerDebug($"Načítavajú sa údaje mapy na začiatku kola...");
                return HookResult.Continue;
            });
                ...
                if (@event.Userid!.IsValid)
                {
                    ...
                    else if (player.IsValid)
                    {
                        ...
                        AddTimer(5.0f, () =>
                        {
                            ...
                            {
                                SharpTimerDebug($"{player.PlayerName} má nesprávny PlayerFov {player.DesiredFOV}... SetFov na {(uint)playerTimers[player.Slot].PlayerFov}");
            ...
            SharpTimerConPrint("Plugin načítaný");
        }
        ...
        public override void Unload(bool hotReload)
        {
            ...
            SharpTimerConPrint("Plugin deaktivovaný");
        }
    }
}
