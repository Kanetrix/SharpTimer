        ...
        private async Task GetDiscordWebhookURLFromConfigFile(string discordURLpath)
        {
            try
            {
                ...
                if (jsonConfig != null)
                {
                    ...
                    discordWebhookBotName = root.TryGetProperty("DiscordWebhookBotName", out var NameProperty) ? NameProperty.GetString()! : "Layzie Club";
            ...
            try
            {
                ...
                var payload = new
                {
                    ...
                    embeds = new[]
                    {
                        new
                        {
                            title = !isSR ? $"Získal nový osobný rekord!" : $"Získal nový serverový rekord",
                            color = 13369599,
                            fields = new object[]
                            {
                                new
                                ...
                                new
                                {
                                    name = "🔢 Počet dokončení:",
                                    value = $"{(!isFirstTime ? timesFinished : "Prvý krát!")}",
                                    inline = true
                                },
                                new
                                {
