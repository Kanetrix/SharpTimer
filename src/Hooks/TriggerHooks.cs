    ...
    public partial class SharpTimer
    {
        public HookResult TriggerMultipleOnStartTouch(CEntityInstance activator, CEntityInstance caller)
        {
            try
            {
                ...
                {
                    InvalidateTimer(player, callerHandle);
                    player.PrintToChat(msgPrefix + $"Časovač bol zrušený z dôvodu nelegálneho pokusu o preskočenie");
                }
                ...
                if (IsValidResetTriggerName(callerName))
                {
                    ...
                    player.PrintToChat(msgPrefix + $"Resetovali ste sa kvôli nelegálnemu pokusu o preskočenie");
                }
